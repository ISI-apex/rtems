...
{
	return jffs2_flash_direct_read(fc, read_buffer_offset, size, return_size, write_buffer);
}
...
{
	return jffs2_flash_direct_write(fc, read_buffer_offset, size, return_size, write_buffer);
}
#endif
